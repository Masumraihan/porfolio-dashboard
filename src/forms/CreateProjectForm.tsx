...
const validation = z.object({
  ...
  image_1: z.string({ required_error: "Image 1 is required" }),
  ...
  isTeamProject: z.string().refine((val) => val === "true" || val === "false", {
    message: "Is Team Project is required",
  }),
...
const CreateProjectForm = () => {
  ...
  const handleSubmit: SubmitHandler<FieldValues> = async (values) => {
    ...
    try {
      ...
      const res = await fetcher(`${process.env.NEXT_PUBLIC_API_BASE_URL}/project`, {
        method: "POST",
